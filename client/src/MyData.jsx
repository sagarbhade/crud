    ...
    render() {
        return <div>
            ...
            <div style={{ height: '800px', display: 'flex', flexDirection: 'column', alignItems:'center', border: '5px solid gray' }}>
                ...
                <input id='t3' onChange={(e)=>this.setState({deptName: e.target.value})} style={{borderRadius: '10px', padding:'10px', height: '45px', width:'330px',margin:'10px', fontSize:'30px'}} placeholder='Enter Department' ></input>
                <input id='t4' onChange={(e)=>this.setState({Salary: parseInt(e.target.value)})} style={{borderRadius: '10px', padding:'10px', height: '45px', width:'330px',margin:'10px', fontSize:'30px'}} placeholder='Enter Salary' ></input>
